...
%%% NF Heatmap Chron vs Algorithm %%%
\begin{figure}[ht]

    \begin{subfigure}{.5\textwidth} % this sets the figure to be max half the width of the page
        \centering
            % include first image
        \includegraphics[width=.9\linewidth]{Output/Graphs/Audit/Heatmaps/US NF chron rank by nf rank - smooth.jpg}  % this sets the image to fill 90% of the available space -> 45% of the line width in total. 
...
%%% NF Ranking Boost by Quartile/Group %%%
% \begin{figure}[!h]
%     \centering
%     \includegraphics[scale=0.75]{Output/Graphs/Audit/Excess Mass/US NF excess mass by ranking group.jpg}
%     \caption{THIS MIGHT HAVE EXCESS MAP HEATMAP NEXT TO IT?}
...
%%% COMMENTING OUT PYMK FIGURES UNTIL WE FIGURE OUT THE NF FIGURES %%%%
...
\begin{figure}
    \begin{subfigure}{.5\textwidth} % this sets the figure to be max half the width of the page
        \centering
            % include first image
        \includegraphics[width=1\linewidth]{Output/Graphs/Experiments/Automaticity/bar chart binary measures.jpg}  % this sets the image to fill 90% of the available space -> 45% of the line width in total. 
