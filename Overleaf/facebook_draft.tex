...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{tab_fig/nf/prefcdf.png}
    \caption{Caption}
    \label{fig:prefcdf}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{tab_fig/nf/nf_rankabovetime.png}
    \caption{Caption}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=1]{tab_fig/pymk/pymk_time_rank_group_pref.png}
    \caption{Caption}
...
\begin{figure}[!h]
    \centering
    \includegraphics[scale=.5]{tab_fig/nf/behavior.png}
    \caption{Caption}
    \label{fig:behavior}
\end{figure}
