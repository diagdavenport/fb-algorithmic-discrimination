...
participant.data <- read.csv("Temp/Clean India qualtrics data.csv")
nf.data.raw <- read.csv("Temp/Clean India Data NF.csv")
pymk.data.raw <- read.csv("Temp/Clean India Data PYMK.csv")
#recent.data.raw <- read.csv("Temp/Clean India Data Recent.csv")
...
participant.data <- participant.data %>% dplyr::select(self.race,
                             gender,
                             age,
                             education,
                             covid.usage,
...
nf.data <- nf.data.raw %>% dplyr::select(subject_religion_RA,
                             subject_gender_RA,
                             total_friends,
                             nf.order,
                             preference,
...
stargazer(final.table,
          out = "Output/Tex/Summary Tables/India NF participants by sample.tex")
...
stargazer(final.table,
          out = "Output/Tex/Summary Tables/India NF nf data by sample.tex")
```
...
stargazer(final.table,
          out = "Output/Tex/Summary Tables/India PYMK data.tex")
```
