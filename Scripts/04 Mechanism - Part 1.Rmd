...
output.dta.early <- read.csv("/Users/diagdavenport/Downloads/Output-2021-08-09.csv")

user.dta.early <- read.csv("/Users/diagdavenport/Downloads/User-2021-08-09.csv")


output.dta.r <- read.csv("/Users/diagdavenport/Downloads/Output-2021-09-21.csv")

user.dta.r <- read.csv("/Users/diagdavenport/Downloads/User-2021-09-21.csv")

movie.dta <- read.csv("/Users/diagdavenport/Downloads/Movie-2021-09-21.csv")

output.dta <- rbind(output.dta.early, output.dta.r)
user.dta <- rbind(user.dta.early, user.dta.r)
...
sql.data$in.group.lax <- sql.data$in.group
