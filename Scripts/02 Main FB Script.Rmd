...
dev.copy(jpeg,'Output/Graphs/Audit/Misranking relative to expectation/US NF by chronological rank.jpg')
dev.off()
...
dev.copy(jpeg,'Output/Graphs/Audit/Misranking relative to expectation/US NF by chronological rank by last login.jpg')
dev.off()
...
dev.copy(jpeg,'Output/Graphs/Audit/Misranking relative to expectation/US NF by raw preference.jpg')
dev.off()
...
dev.copy(jpeg,'Output/Graphs/Audit/Misranking relative to expectation/US NF by norm preference.jpg')
dev.off()
...
dev.copy(jpeg,'Output/Graphs/Audit/Misranking relative to expectation/US PYMK by mutual friend ranking.jpg')
dev.off()
```
...
dev.copy(jpeg,'Output/Graphs/Audit/Heatmaps/US NF 4 x 60.jpg')
dev.off()
