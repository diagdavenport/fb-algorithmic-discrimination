...
# print(summary_table(participant.data, summary_statistics),
#       rtitle = "NF Sample", 
#       align = "lc")
# 
# t <- participant.data %>% dplyr::filter(source %in% c("CDR 1", "HDSL"))
# 
# print(summary_table(t, summary_statistics),
#       rtitle = "PYMK Sample", 
#       align = "lc")
# 
# t <- participant.data %>% dplyr::filter(source %in% c("CDR 2", "CDR 4"))
# 
# print(summary_table(t, summary_statistics),
#       rtitle = "Behavior Sample", 
#       align = "lc")
...
print(summary_table(nf.data.raw, summary_statistics),
      rtitle = "NF Sample", 
      align = "lc")
...
kbl(summary_table(t, summary_statistics), booktabs = T)
...
print(summary_table(pymk.data.raw, summary_statistics),
      rtitle = "PYMK Sample", 
      align = "lc")
...
print(summary_table(recent.data.raw, summary_statistics),
      rtitle = "Behavior Sample", 
      align = "lc")
